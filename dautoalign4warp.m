...
function dautoalign4warp(apix, fiducial_diameter_nm, nominal_rotation_angle, workflows_folder)
    ...
    % Iterate over directories looking for .st files generated by warp
    % Align these tilt series using dynamo tilt series alignment tools
    % Convert final fiducial positions into IMOD model
    % Run tiltalign on this model to output IMOD transformations and alignment info
    % Clean up so the folder structure looks like a normal IMOD alignment, ready for import into warp
